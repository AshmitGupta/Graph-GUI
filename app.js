            ...
            if (req.file == undefined) {
                ...
                fs.readFile(xmlFilePath, 'utf-8', async (err, data) => {
                    if (err) {
                        ...
                        try {
                            await createGraphFromXML(data, socket, registration);
...
// Move the createGraphFromXML function into app.js
async function createGraphFromXML(xmlData, socket, registration) {
